...
async def get_conversation_messages(
    ...
    History lives in PostgresSaver under thread_id = user-{id}-conversation-{id}
    (see graph/checkpointer.make_thread_id); we read it through the compiled
    graph's aget_state rather than touching checkpoint blobs directly.
