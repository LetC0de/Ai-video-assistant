  ...
  return (
    <div className="auth">
      <div className="auth-bg" aria-hidden="true">
        <div className="blob blob--violet auth__blob--violet" />
        <div className="blob blob--spark auth__blob--spark" />
        <div className="blob blob--indigo auth__blob--indigo" />
        <div className="grain" />
      </div>
      ...
      <div className="auth__card">
        ...
        <div className="auth__card-head">
          ...
          <p className="auth__sub">
            {mode === 'login'
              ? 'Log in to keep chatting with your videos and meetings.'
              : 'Sign up to turn any video into a searchable, chat-ready meeting.'}
          </p>
        </div>
